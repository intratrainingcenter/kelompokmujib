  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        {!!Form::open(['route' => 'kelas.store', 'class' => 'box-body'])!!}
        <div class="form-group">
          {!! Form::label('kode_kelas', 'Kode Kelas')!!}
          {{Form::text('kode_kelas', $new_kode, array_merge(['class' => 'form-control', 'readonly', 'placeholder' => 'Nama Kelas']))}}
        </div>
        <div class="form-group">
          {!! Form::label('nama_kelas', 'Nama Kelas')!!}
          {{Form::text('nama_kelas', '', array_merge(['class' => 'form-control', 'required', 'placeholder' => 'Nama Kelas']))}}
        </div>
