  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Jadwal Pelajaran</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            <div class="box-body">
                <div class="form-group">
                  {!! Form::open(['route' => ['jadwal.update', $data->id], 'method' => 'patch']) !!}
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    {{ Form::select('kode_mapel', $selectmapel, $data->kode_mapel, ['placeholder' => 'Pilih Mata Pelajaran', 'id' => 'kode_mapel', 'class' => 'form-control', 'required' => true]) }}
                  </div>
